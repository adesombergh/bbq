...
- Because the board unmounts with the footer, a run ends when the round lands and nothing is remembered but the all-time best, in `localStorage` beside `bbq:theme`.
